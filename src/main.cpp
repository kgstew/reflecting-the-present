    ...
    if (current_time - last_demo_time > 3000) {
        ...
        switch (demo_step) {
            ...
            case 1:
                ...
                StripPatternManager::setStripPattern(5, PATTERN_SOLID_COLOR, CRGB::White, 2000);
                break;
            ...
            case 4:
                ...
                for (int i = 15; i < 19; i++) {
                    StripPatternManager::setStripPatternWithDelay(i, PATTERN_SOLID_COLOR, CRGB::Blue, (i-15)*200, 1500);
                }
                break;
